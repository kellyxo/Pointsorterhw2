...
class QuickSorterTest {
    ...
    public void testSortByXBreak()
    {
        ...
        assertThrows(IllegalArgumentException.class,() ->{
            sorter = new QuickSorter(EmptySet); // make new sorter
        });
    ...
    public void testSortSinglePointbyX() {
        ...
        sorter = new QuickSorter(singlePointArray);
    ...
    public void testSortDuplicatePointsbyX() {
        ...
        sorter = new QuickSorter(duplicatePointsArray);
        sorter.setComparator(0); // Set comparator to sort by x-coordinate
        sorter.sort();
    ...
    public void testSortNegativeCoordinatesbyY() {
        ...
        sorter = new QuickSorter(negativeCoordinatesArray);
    ...
    {
        sorter = new QuickSorter(points);
        assertEquals("QuickSort",sorter.algorithm);
    }
