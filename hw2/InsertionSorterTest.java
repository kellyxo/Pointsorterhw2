...
class InsertionSorterTest {
    ...
    public void testSortByXBreak()
    {
        ...
        assertThrows(IllegalArgumentException.class,() ->{
            sorter = new InsertionSorter(EmptySet); // make new sorter
        });
    ...
    public void testSortSinglePointbyX() {
        ...
        sorter = new InsertionSorter(singlePointArray);
    ...
    public void testSortDuplicatePointsbyX() {
        ...
        sorter = new InsertionSorter(duplicatePointsArray);
        sorter.setComparator(0); // Set comparator to sort by x-coordinate
        sorter.sort();
    ...
    public void testSortNegativeCoordinatesbyY() {
        ...
        sorter = new InsertionSorter(negativeCoordinatesArray);
    ...
    {
        sorter = new InsertionSorter(points);
        assertEquals("InsertionSorter",sorter.algorithm);
    }
}