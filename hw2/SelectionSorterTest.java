...
public class SelectionSorterTest
{
    ...
    public void testSortByXBreak()
    {
        ...
        assertThrows(IllegalArgumentException.class,() ->{
            sorter = new SelectionSorter(EmptySet); // make new sorter
        });
    ...
    public void testSortSinglePointbyX() {
        ...
        sorter = new SelectionSorter(singlePointArray);
    ...
    public void testSortDuplicatePointsbyX() {
        ...
        sorter = new SelectionSorter(duplicatePointsArray);
        sorter.setComparator(0); // Set comparator to sort by x-coordinate
        sorter.sort();
    ...
    public void testSortNegativeCoordinatesbyY() {
        ...
        sorter = new SelectionSorter(negativeCoordinatesArray);
    ...
    {
        sorter = new SelectionSorter(points);
        assertEquals("SelectionSort",sorter.algorithm);
    }
}
